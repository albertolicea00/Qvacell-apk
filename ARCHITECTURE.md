...
- Android's `ACTION_DIAL` always opens the system dialer for user confirmation before a call is placed — the app cannot dial silently (by design, and matches iOS's `tel://` confirmation behavior).
